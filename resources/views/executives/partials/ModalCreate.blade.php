            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                <div class="p-4 bg-gray-200">
                    <div class="p-4 bg-white rounded-md">
                        <div class="my-3">
                            <p class="text-xl font-semibold"> Agregar Ejecutivos </p>
                        </div>
                            ...
                            <form class="my-3 mx-2" method="post" id="form-create">
                                <div class="flex justify-between">
                                    ...
                                    <div class="py-2 w-3/6 ml-2">
                                        <label for="lastname" class="block mb-2 text-sm font-medium">Apellidos <span
                                ...
                                <div class="flex justify-between">
                                    <div class="py-2 w-3/6 mr-3">
                                        ...
                                        <div class="mt-4">
                                            <img id="photoPreview" class="hidden w-32 h-32 object-cover rounded-md"
                                                src="" />
                                        </div>
                                    </div>
                                    <div class="w-3/6">
                                        <div class="py-2 ml-2">
                                            <label for="phone" class="block mb-2 text-sm font-medium">Celular <span
                                                    class="text-red-500"> * </span> </label>
                                            <input type="text" id="phone" name="phone" required
                                                class="w-full py-2 border gray-400 border-2 rounded-md px-2 upper-case">
                                        </div>
                                        <div class="py-2 ml-2">
                                            <label for="address" class="block mb-2 text-sm font-medium">Dirección <span
                                                    class="text-red-500"> * </span> </label>
                                ...
                                <div class="py-2">
                                    <label for="position" class="block mb-2 text-sm font-medium"> Cargo
                                        <span class="text-red-500"> * </span> </label>
